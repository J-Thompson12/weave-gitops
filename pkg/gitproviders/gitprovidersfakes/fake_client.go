...
type FakeClient struct {
	GetProviderStub        func(gitproviders.NormalizedRepoURL, gitproviders.AccountTypeGetter) (gitproviders.GitProvider, error)
	getProviderMutex       sync.RWMutex
	getProviderArgsForCall []struct {
		arg1 gitproviders.NormalizedRepoURL
...
func (fake *FakeClient) GetProvider(arg1 gitproviders.NormalizedRepoURL, arg2 gitproviders.AccountTypeGetter) (gitproviders.GitProvider, error) {
...
func (fake *FakeClient) GetProviderCalls(stub func(gitproviders.NormalizedRepoURL, gitproviders.AccountTypeGetter) (gitproviders.GitProvider, error)) {
	fake.getProviderMutex.Lock()
	defer fake.getProviderMutex.Unlock()
	fake.GetProviderStub = stub
}

func (fake *FakeClient) GetProviderArgsForCall(i int) (gitproviders.NormalizedRepoURL, gitproviders.AccountTypeGetter) {
	fake.getProviderMutex.RLock()
	defer fake.getProviderMutex.RUnlock()
